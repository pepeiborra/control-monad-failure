...
instance (WrapFailure e m, Monoid w, Applicative m, Monad m) => WrapFailure e (Lazy.WriterT w m) where
...
instance (WrapFailure e m, Monoid w, Applicative m, Monad m) => WrapFailure e (Strict.RWST r w s m) where
